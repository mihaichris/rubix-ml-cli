...
test('tokenize command will return ok', function () {
    $this->artisan(
        'tokenizer:ngram',
        [
            'input-file' => 'tests\fixture\en-tokenize-n-gram.input',
...
test('tokenize with file', function () {
    $expected = File::get('tests\fixture\en-tokenize-n-gram.output');
...
test('tokenize without input file', function () {
    ...
    $this->artisan('tokenizer:ngram', ['output-file' => 'tests\output\en-tokenize-n-gram.output']);
});

test('tokenize without output file', function () {
    $this->expectExceptionMessage('Not enough arguments (missing: "output-file").');
    $this->artisan('tokenizer:ngram', ['input-file' => 'tests\fixture\en-tokenize-n-gram.input']);
});
